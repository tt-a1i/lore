...
#intro-overlay {
  ...
  /* --bg 不透明打底 + 微弱径向光晕（绿，极淡）*/
  background:
    radial-gradient(900px 600px at 50% 38%, rgba(86, 211, 100, 0.07) 0%, rgba(10, 13, 18, 0) 60%),
    var(--bg);
  opacity: 0;
...
.intro-watch {
  ...
  box-shadow: 0 0 0 0 rgba(86, 211, 100, 0.0), 0 0 22px rgba(86, 211, 100, 0.18);
  transition: all var(--t-fast);
}
.intro-watch:hover {
  background: rgba(86, 211, 100, 0.16);
  box-shadow: 0 0 0 4px rgba(86, 211, 100, 0.12), 0 0 30px rgba(86, 211, 100, 0.32);
  ...
  function buildOverlay(opts) {
    ...
    el.innerHTML =
      '<div class="intro-stage">' +
        ...
        '<div class="intro-headline">' + esc(T('intro.headline', 'Software is made between commits.')) + '</div>' +
